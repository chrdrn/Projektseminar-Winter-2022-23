...
\hypersetup{
  pdftitle={Datenaufbereitung I},
  pdfauthor={Julius Klingelhoefer},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{list.files}\NormalTok{(}\StringTok{"../../../image/"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{../../../image/logo.svg}
